...
class OptionVisualHelpers {
    /**
     * Creates a glowing animated toggle switch icon for boolean options.
     */
    ...
    /**
     * Creates a modern category banner header with bottom accent divider lines.
     */
    ...
    /**
     * Smoothly scales up a UI element on selection/hover.
     */
