...
class StringTools {
	...
	**/
    ...
    /**
        ...
        Quickly formats a song name for file system reading (e.g., "Bopeebo (Remix)" -> "bopeebo-remix").
    **/
    ...
    /**
        [SOULSCORCH EXTENSION] 
        Safely converts a string to a Float, defaulting to 0 if the string is invalid or empty.
    **/
    public static function forceFloat(s:String):Float {
