...
class GameConfig {
    ...
    public function load():Void {
        try {
            ...
            Logger.info("[GAME CONFIG] Configuration loaded successfully from disk.", "config");
        } catch (e:Dynamic) {
            Logger.error('[GAME CONFIG] Failed to load configuration: $e', "config");
        }
    }
    ...
    public function save():Void {
        try {
            ...
            Logger.info("[GAME CONFIG] Configuration flushed and saved to disk.", "config");
        } catch (e:Dynamic) {
            Logger.error('[GAME CONFIG] Failed to save configuration: $e', "config");
        }
    }
